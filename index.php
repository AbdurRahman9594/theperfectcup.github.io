        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <hr class="visible-xs">
                    <p>Making the perfect cup of coffee can be challenging! With so many unique flavours and recipes to choose from, where do you begin? Our website provides you with the best recipes from around the world. Whether you prefer your coffee hot and mild or bracingly cold and strong are sure to have what you are looking for. For access to unlimited recipes, you must register! Registration is free. Click on the Blog icon and get started.!</p>
                </div>
            </div>
        </div>
